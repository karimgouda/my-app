...
<body>
    ...
    <div class=" w-50 m-auto  all text-white mt-5">
        <h1 class="text-center text-white -50 mb-3">All Users</h1>
        @foreach ($user as $userX )

        <h4 class=" text-center bg-primary my-2">{{$loop->iteration}} -<a href="{{url("selectUser/$userX->id")}}">{{ $userX->name }}</a></h4>
    @endforeach
    </div>
