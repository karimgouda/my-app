...
<body>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class=" nav-item mx-2">
                    <a class="nav-link active" aria-current="page" href="{{ url("/show/$category->id") }}">Back</a>
                </li>
    ...
    <div class=" demo ">
        ...
        <form action="{{ url("/update/$category->id") }}" method="POST" enctype="multipart/form-data">
            ...
            <textarea name="desc" id="desc" cols="20" rows="5" class=" form-control ">{{ $category->desc }}</textarea>
            @error('desc')
            <p class=" text-danger"> {{ $message }} </p>
        @enderror
